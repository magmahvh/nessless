...
void C_World::Clantag( )
{
	...
	if (g_Settings->m_bTagChanger)
	{
		...
		auto ticks = TIME_TO_TICKS(nci->GetAvgLatency(FLOW_OUTGOING)) + (float)g_Globals.m_Interfaces.m_GlobalVars->m_iTickCount; //-V807
		auto intervals = 0.5f / g_Globals.m_Interfaces.m_GlobalVars->m_flIntervalPerTick;

		auto main_time = (int)(ticks / intervals) % 19;

		if (main_time != time && !g_Globals.m_Interfaces.m_ClientState->m_nChokedCommands( ) )
		{
			auto tag = "";
			switch (main_time)
			{
			...
			case 1: tag = "z"; break;
			case 2: tag = "ze"; break;
			case 3: tag = "zee"; break;
			case 4: tag = "zeer"; break;
			case 5: tag = "zeero"; break;
			case 6: tag = "zeeron"; break;
			case 7: tag = "zeeron."; break;
			case 8: tag = "zeeron.s"; break;
			case 9: tag = "zeeron.su"; break;
			case 10: tag = "zeeron.su"; break;
			case 11: tag = "zeeron.su"; break;
			case 12: tag = "zeeron.s"; break;
			case 13: tag = "zeeron."; break;
			case 14: tag = "zeeron"; break;
			case 15: tag = "zeero"; break;
			case 16: tag = "zeer"; break;
			case 17: tag = "zee"; break;
			case 18: tag = "ze"; break;
			case 19: tag = "z"; break;
			}

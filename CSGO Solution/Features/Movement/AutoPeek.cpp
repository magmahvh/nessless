...
void C_AutoPeek::DrawCircle( )
{
	...
	{
		if ( m_bWaitAnimationProgress )
			g_Render->RenderCircle3D( m_vecStartPosition, 32, 15.0f * flAnimationProgress, Color( 255, 255, 255, 255 ) );
		else
	...
	return g_Render->RenderCircle3D( m_vecStartPosition, 32, 15.0f * flAnimationProgress, Color( 255, 255, 255, 255 ) );
}
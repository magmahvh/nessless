...
public:
	...
	NETVAR( m_szCustomName, char, FNV32( "DT_BaseAttributableItem" ), FNV32( "m_szCustomName" ) );
};
...
public:
	...
	PushVirtual( UpdateAccuracyPenalty( ), 484, void( __thiscall* )( void* ) );
	PushVirtual( GetWeaponData( ), 461, C_CSWeaponData*( __thiscall* )( void* ) );
	PushVirtual( GetInaccuracy( ), 483, float( __thiscall* )( void* ) );
	PushVirtual( GetSpread( ), 453, float( __thiscall* )( void* ) );

	DATAMAP( int32_t, m_Activity );

	float_t& m_flNextPrimaryAttack( )
	{
		return *( float_t* )( ( uintptr_t )( this ) + 0x3248 );
	}
	float_t& m_flPostponeFireReadyTime( )
	{
		return *( float_t* )( ( uintptr_t )( this ) + 0x335C );
	}
	float_t& m_flNextSecondaryAttack( )
	{
		return *( float_t* )( ( uintptr_t )( this ) + 0x324C );
	}
	int16_t& m_iItemDefinitionIndex( )
	{
		return *( int16_t* )( ( uintptr_t )( this ) + 0x2FBA );
	}
	...
	CUSTOM_OFFSET( m_hThrower, CHandle < C_BasePlayer >, FNV32( "m_hThrower" ), 0x29B0 );
	CUSTOM_OFFSET( m_flDamage, float_t, FNV32( "m_flDamage" ), 0x29A8 );
	CUSTOM_OFFSET( m_flDamageRadius, float_t, FNV32( "m_flDamageRadius" ), 0x2994 );
};
...
void C_SetUp::SetupHooks( )
{
	...
	LPVOID pCL_Move						= g_Tools->FindPattern( g_Globals.m_ModuleList.m_EngineDll, _S( "55 8B EC 81 EC 64 01 00 00 53 56 8A F9" ) );
	LPVOID pCreateMove					= g_Tools->FindPattern( g_Globals.m_ModuleList.m_ClientDll, _S( "55 8B EC 8B 4D 04 83 EC 08 8B C1" ) );
	...
	LPVOID pModifyEyePosition           = g_Tools->FindPattern( g_Globals.m_ModuleList.m_ClientDll, _S( "55 8B EC 83 E4 F8 83 EC 70 56 57 8B F9 89 7C 24 14 83 7F 60"));
	...
	LPVOID pOverrideView				= g_Tools->FindPattern( g_Globals.m_ModuleList.m_ClientDll, _S( "55 8B EC 83 E4 F8 8B 4D 04 83 EC 58" ) );
	LPVOID pGetViewmodelFOV				= g_Tools->FindPattern( g_Globals.m_ModuleList.m_ClientDll, _S( "55 8B EC 8B 4D 04 83 EC 08 57 8B C1 83 C0 08" ) );
	LPVOID pSendNetMessage				= g_Tools->FindPattern( g_Globals.m_ModuleList.m_EngineDll, _S( "55 8B EC 83 EC 08 56 8B F1 8B 4D 04 8B C1 83 C0" ) );
	...
	LPVOID pGetClientModelRenderable	= g_Tools->FindPattern( g_Globals.m_ModuleList.m_ClientDll, _S( "56 8B F1 80 BE FC 26" ) );
...
void C_SetUp::SetupAddressList( )
{
	...
	g_Globals.m_AddressList.m_IsConnected_Call						=	g_Tools->FindPattern( g_Globals.m_ModuleList.m_ClientDll, _S( "84 C0 75 05 B0 01 5F" ) );
	...
	g_Globals.m_AddressList.m_TraceFilterSkipTwoEntities			=	g_Tools->FindPattern( g_Globals.m_ModuleList.m_ClientDll, _S( "55 8B EC 81 EC BC 00 00 00 56 8B F1 8B 86" ) ) + 550;

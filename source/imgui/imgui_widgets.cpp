...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    const ImRect total_bb(pos, pos + ImVec2(square_sz + (style.ItemInnerSpacing.x + label_size.x + 0) + 14, 0 + label_size.y + style.FramePadding.y * 2));
    ItemSize(total_bb, style.FramePadding.y);
    ItemAdd(total_bb, id);
    ...
    if (*v)
    {
        window->DrawList->AddRectFilled(ImVec2(total_bb.Min.x, total_bb.Min.y + 2), ImVec2(total_bb.Min.x + 30, total_bb.Min.y + 18), ImColor(150, 170, 235, 255), 10, 15);
    ...
    {
        window->DrawList->AddRectFilled(ImVec2(total_bb.Min.x, total_bb.Min.y + 2), ImVec2(total_bb.Min.x + 30, total_bb.Min.y + 18), ImColor(43, 43, 43, 255), 10, 15);
    ...
    ImGui::RenderText(ImVec2(total_bb.Min.x + style.ItemInnerSpacing.x + 35, total_bb.Min.y + style.FramePadding.y + 0), label);
    ImGui::PopStyleColor();
    return pressed;
}
